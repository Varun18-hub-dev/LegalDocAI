...
export const UserCompare: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto flex flex-col gap-8 select-none">
      ...
      {/* Select Box */}
      <form onSubmit={handleCompare} className="glass-card p-6 border border-brand-border bg-brand-secondary/40 flex flex-col md:flex-row md:items-end gap-6">
        <div className="flex-1 flex flex-col gap-2">
          ...
          <select 
            ...
            className="bg-brand-dark border border-brand-border text-xs text-gray-300 rounded-xl px-4 py-3 outline-none cursor-pointer focus:text-white"
            required
          >
        ...
        <button 
          ...
          className="btn-gradient px-6 py-3 rounded-xl flex items-center justify-center gap-2 font-heading text-sm font-semibold tracking-wider uppercase disabled:opacity-40 disabled:cursor-not-allowed select-none"
        >
          {loading ? (
            <>
